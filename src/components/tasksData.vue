...
<template>
     <div class="mx-7 py-5 flex w-[255px]">
        <RouterLink class="w-1/4 text-center mr-1" to="/dashboard/tasks">
                ...
                <div class="w-full text-center p-1 text-xs text-white bg-blue-300 rounded-lg">
            ...
            <RouterLink to="/dashboard/tasks" class="w-1/4 text-center mr-1">
              <div class=" w-full text-center p-1 text-xs text-white bg-sky-600 rounded-lg">
            ...
            <RouterLink to="/dashboard/tasks" class="w-1/4 text-center mr-1">
              <div class=" w-full text-center p-1 text-xs text-white bg-sky-700 rounded-lg">
            ...
            <RouterLink to="/dashboard/archived" class="w-1/4 text-center">
              <div class="w-full text-center mr-1 p-1 text-xs text-white  bg-sky-800 rounded-lg">

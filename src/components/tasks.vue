<template>
  <div
    class="h-[95vh] py-5 text-center text-sky-900 shadow-xl bg-slate-300 group"
  >
    <h1 class="text-2xl text-center text-sky-900 bg-slate-300">Tasks</h1>
    <table
      class="tableWidth py-2 px-10 bg-slate-300 group space-x-6 border-separate border-spacing-6"
    >
      <thead class="">
        <tr>
          <th
            class="max-w-1/3 min-w-[300px] h-auto py-2 px-2 rounded-lg text-slate-300 group bg-sky-900 shadow-xl"
          >
            <div clas="flex tableHead">
              <img
                src="../../src/icons/clockwise-icon.svg"
                alt="clockIcon"
                class="w-5 ml-1 tableIcon"
              />
              <span>- • TO DO • -</span>
            </div>
          </th>
          ...
          >
            <div clas="flex tableHead">
              <img
                src="../../src/icons/inProgress-icon.svg"
                alt="clockIcon"
                class="w-7 ml-1 tableIcon"
              />
              <span>- • ACTIVE • -</span>
            </div>
          </th>
            ...
            >
              ...
              <div>
                ...
                <div v-if="this.taskId === task.id" class="mx-auto flex">
                  <input
                    v-model="task.title"
                    class="displayInput mx-auto mt-3 text-sm font-light pl-2 rounded-md"
                    type="text"
                    v-show="message"
                    placeholder="edit me"
                  />
                  <button @click="updateTaskTitle(task.title, task.id)">
                    <svg
                      class="h-4 w-4 mt-3 ml-[-55px] text-black"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      stroke-width="2"
